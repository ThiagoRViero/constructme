            ...
            while ($rs = $stmt->fetch(PDO::FETCH_ASSOC)):
                if (($contador <= $pagina * 20) && ($contador >= $pagina * 20 -20)) {?>
                    <div class="mb-4 col-md-4 col-lg-3 col-sm-6 mt-2 text-break">
                        ...
                        <a href="editarSolucao.php?codigo=<?php echo $rs['id']?>" class="btn btn-primary float-left ml-2">Editar</a>
                        <a href="exluirSolucao.php?codigo=<?php echo $rs['id'] ?> <?php echo '&pagina=',$pagina,'&tipoSolucao=', $tipo, '&filtro=', $filtro; ?>" class="btn btn-danger float-right mr-2">Excluir</a>
